  ...
  * 		https://www.saitolab.org/fp_site/									
  	+ 端末識別に関して１００％信頼できる手法がないため、									
   	  何らかのユーザ認証方式に変更する必要がある									
  		- ①	生体認証								
  		- ②	デバイス認証しつつ、ログイン認証と組み合わせ（デバイス情報が変更となった場合は、ログインさせる等）								
  		- ③	Googleの認証を利用する（Androidのアカウントを使用）								

### Link
* [Blazor with Database First](https://entityframeworkcore.com/ja/knowledge-base/59955735/)
* [ASP .NET Core 3.1 + EntityFramework Core を使って、一対多のリレーションがあるデータをレスポンスしてみた](https://thinkami.hatenablog.com/entry/2019/12/17/224720#StartupcsにDbContextと接続文字列を追加)
* [認証が有効な Blazor Wasm アプリで、アクセストークンなしで匿名アクセス可能なエンドポイントに HTTP リクエストを送信する ](https://devadjust.exblog.jp/28138344/)
* [【JWT】 入門](https://qiita.com/Naoto9282/items/8427918564400968bd2b)
* [JWT認証と流れのやわらかい解説](https://techblog.roxx.co.jp/entry/2019/03/13/135739)
* [JWTをセッション管理に転用するのはあまり良いアイデアではない(認証だけならいいよ)](https://anatoo.hatenablog.com/entry/2018/10/03/000518)
...
* [デバイスを判別する5つの方法](https://unskilled.site/デバイスを判別する5つの方法/)
